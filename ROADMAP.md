...
| [Program-First Onboarding with Auto-Seeded Lifts](docs/proposals/2026-06-28-onboarding-program-first-lift-seeding.md) | Reorder wizard to Choose Program before Enter Lifts; seed the lifts panel from `PRESET_BASE_SPECS` when the list is empty; depends on #592 for full RPT coverage | [#599](https://github.com/brownm09/lifting-logbook/issues/599) | draft |
