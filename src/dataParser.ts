// RPT Program Spec interface and parser
interface RptProgramSpec {
  offset: number;
  lift: string;
  increment: number;
  order: number;
 ...
 */
function tableToObjects<T = Record<string, any>>(data: any[][], headerMap?: Record<string, string>): T[] {
...
// Define the TrainingMax type for clarity
...
export { tableToObjects, parseTrainingMaxes, TrainingMax, parseRptProgramSpec, RptProgramSpec };