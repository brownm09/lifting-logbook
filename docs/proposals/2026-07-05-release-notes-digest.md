...
- [ ] `docs/adr/ADR-030` documents the release-notes approach and includes a `## References` section.
...
- `C:\Users\brown\.claude\plans\release-notes-digest-for-effervescent-aurora.md` — the full, approved implementation plan; the detailed design reference this PRD-lite doc defers to.
